I find tracking expenses using a mobile device convenient. One of the challenges has been finding applications that focus primarily on this. Do add ones with a brief description you find useful.
