...
<!-- Generated by "Shake webmanuals" from hledger-lib/hledger_csv.m4.md doc/common.m4 hledger-lib/defs.m4 hledger-lib/hledger_journal.m4.md hledger-lib/hledger_timeclock.m4.md hledger-lib/hledger_timedot.m4.md -->
...
[posting](journal.html#postings) to be generated, with that account
name.
...
price](journal.html#transaction-prices), which can be useful.
...
assignment](journal.html#balance-assignments)) on posting N.
...
when parsing numbers (cf [Amounts](journal.html#amounts)). However if
