...
-   If there is a [commodity directive](#declaring-commodities) for the
...
display format directly, but occasionally they can do so indirectly. (Eg
...
2.  It declares what decimal mark character to expect when parsing
    ...
    data. (Without this, hledger will parse both `1,000` and `1.000` as
    1).
