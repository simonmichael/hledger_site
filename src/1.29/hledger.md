...
styles](#commodity-display-styles), such as the number of decimal places
...
([#203](https://github.com/simonmichael/hledger/issues/203)), (and you
...
style](#commodity-display-styles), eg the placement of commodity symbols
