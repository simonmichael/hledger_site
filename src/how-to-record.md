...
- If you have custom scripts to help with tasks, make them print or append journal entries when appropriate.
  Eg have your [invoicing script](https://github.com/plaintextaccounting/hledger/tree/main/examples/invoicing/invoice-script) add an invoice transaction to the journal.
