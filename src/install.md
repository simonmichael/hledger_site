...
The current hledger release is **1.43.1**.
...
[![hledger release binaries](https://img.shields.io/badge/hledger_release_binaries-1.43.1-brightgreen.svg)](https://github.com/simonmichael/hledger/releases/tag/1.43.1)
`eget simonmichael/hledger --all`

[release binaries]:    https://github.com/simonmichael/hledger/releases/tag/1.43.1
...
[![Docker](https://img.shields.io/badge/Docker_image-1.43.1-brightgreen.svg)](https://hub.docker.com/r/dastapov/hledger)
...
Get the [hledger source code](https://github.com/simonmichael/hledger/commits/master) with [git](https://git-scm.com):
    ...
    cd hledger
    git checkout 1.43.1   # switch to the latest release tag (optional)
