...
The current hledger release is **1.43**.
...
[![hledger release binaries](https://img.shields.io/badge/hledger_release_binaries-1.43-brightgreen.svg)](https://github.com/simonmichael/hledger/releases/tag/1.43)
`eget simonmichael/hledger --all`

[release binaries]:    https://github.com/simonmichael/hledger/releases/tag/1.43
...
[![Docker](https://img.shields.io/badge/Docker_image-1.43-brightgreen.svg)](https://hub.docker.com/r/dastapov/hledger)
