...
and the current preview release for hledger 2.x is **1.99.3** (2.0 preview 3).
...
[release binaries]:    https://github.com/simonmichael/hledger/releases/tag/1.52.2
...
[![Docker](https://img.shields.io/badge/Docker_image-1.52.1-red.svg)](https://hub.docker.com/r/dastapov/hledger) `docker pull dastapov/hledger`
