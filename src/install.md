...
The current hledger release is **1.27.1**. ([Release notes](release-notes))
...
<table class="mac downloads">
  ...
  <tr> <!-- CI BINARIES -->
    <td>
      <div class="badges">
        <a><img alt="hledger CI binaries" src="https://img.shields.io/badge/hledger_CI_binaries-1.27.1-brightgreen.svg" /></a><br>
      </div>
      <!-- <div class="notes">Linux, Mac, Windows</div> -->
    </td>
    <td>
      <div class="command">
        <a href="https://github.com/simonmichael/hledger/releases/tag/1.27.1#mac-x64">hledger-mac-x64.zip</a>
      </div>
      <div class="notes"></div>
    </td>
  </tr>
...
<table class="windows downloads">
  ...
  <tr> <!-- CI BINARIES -->
    ...
    <td>
      <div class="command">
        <a href="https://github.com/simonmichael/hledger/releases/tag/1.27.1#windows-x64">hledger-windows-x64.zip</a>
...
<table class="linux downloads">
  ...
  <tr> <!-- CI BINARIES -->
    ...
    <td>
      <div class="command">
        <a href="https://github.com/simonmichael/hledger/releases/tag/1.27.1#linux-x64">hledger-linux-x64.zip</a>
      </div>
      <div class="notes"></div>
    </td>
  </tr>
...
<table class="multiplatform downloads">
  ...
  <tr> <!-- DOCKER -->
    <td>
      <div class="badges">
        <a href="https://hub.docker.com/r/dastapov/hledger"><img alt="Docker" src="https://img.shields.io/badge/Docker_image-1.27.1-brightgreen.svg" /></a><br>
...
<img alt="Release source" src="https://img.shields.io/badge/Release_source-1.27.1-brightgreen.svg" />
