...
[CSV rules](https://github.com/plaintextaccounting/hledger/blob/main/examples/csv/xpensetracker.csv.rules)\
...
[CSV rules](https://github.com/plaintextaccounting/hledger/blob/main/examples/csv/eternity.csv.rules)
