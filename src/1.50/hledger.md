...
This manual is for hledger\'s command line interface, version 1.50.5. It
...
nothing else. If you have trouble with it, see \"Regular expressions\"
...
`env | grep LEDGER_FILE` will show your file, and so will
`hledger files`.
