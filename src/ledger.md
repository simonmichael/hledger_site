...
(Goal is current dev goal: Yes/Ignored/Error)
...
| `end` close block commands like `apply` or `comment`                                                                                                  | N        | N   | hledger uses `end comment` and `end apply account`                             | Y    |
...
| `year`/`Y` set the year for year-less dates                                                                                                           | only `Y` | Y   |                                                                                | Y    |
