...
(Goal is current dev goal: Support/Ignore/Error)

| Supported in hledger ?                                                                                                                                | Y | N                                                                              | Goal |
|-------------------------------------------------------------------------------------------------------------------------------------------------------|---|:-------------------------------------------------------------------------------|------|
| **Transactions**                                                                                                                                      |   |                                                                                |      |
...
| [5.9 Expression amounts](https://www.ledger-cli.org/3.0/doc/ledger3.html#Expression-amounts)                                                          |   | N                                                                              | E    |
...
| [5.15 Virtual posting costs](https://www.ledger-cli.org/3.0/doc/ledger3.html#Virtual-posting-costs)                                                   |   | the parentheses are ignored                                                    | I    |
| [5.16 Commodity prices](https://www.ledger-cli.org/3.0/doc/ledger3.html#Commodity-prices)                                                             |   | cost basis is not tracked separately from cost                                 | S    |
| [5.16.1 Total commodity prices](https://www.ledger-cli.org/3.0/doc/ledger3.html#Total-commodity-prices)                                               |   | some lot notation is ignored, but transactions may fail to balance             | S    |
...
| [5.19 Lot dates](https://www.ledger-cli.org/3.0/doc/ledger3.html#Lot-dates)                                                                           |   | N                                                                              | S    |
| [5.20 Lot notes](https://www.ledger-cli.org/3.0/doc/ledger3.html#Lot-notes)                                                                           |   | N                                                                              | S    |
| [5.21 Lot value expressions](https://www.ledger-cli.org/3.0/doc/ledger3.html#Lot-value-expressions)                                                   |   | N                                                                              | E    |
...
| `;` `#` `%` `*` &#124; comment lines                                                                                                                  |   | `%` and &#124; are not supported                                               | E    |
| `!` or `@` as a directive prefix                                                                                                                      |   | `@` is not supported                                                           | S    |
| `account` pre-declare account names                                                                                                                   | Y |                                                                                |      |
| `account` subdirectives                                                                                                                               |   | ignored                                                                        | I/S  |
| `apply account` set a default parent account                                                                                                          | Y |                                                                                |      |
| `apply fixed` set fixated prices                                                                                                                      |   | N                                                                              | I    |
| `alias` rewrite account names                                                                                                                         | Y |                                                                                |      |
| `assert` error if a value expression fails                                                                                                            |   | N, consider hledger check or hledger-check-fancyassertions                     | I    |
| `bucket`/`A` set a default balancing account                                                                                                          |   | N                                                                              | I    |
| `capture` replace accounts matched by regex with another                                                                                              |   | can be emulated with regex `alias`                                             | I    |
| `check` warn if a value expression fails                                                                                                              |   | N, consider hledger check or hledger-check-fancyassertions                     | I    |
| `comment` start multi-line comments                                                                                                                   | Y |                                                                                |      |
| `commodity` pre-declare commodities                                                                                                                   | Y |                                                                                |      |
| `commodity` subdirectives                                                                                                                             |   | only `format`                                                                  | I/S  |
| `define` define value expressions for future use                                                                                                      |   | N                                                                              | I    |
| `end` close block commands like `apply` or `comment`                                                                                                  |   | hledger uses `end comment` and `end apply account`                             | S    |
| `expr` evaluate some value expression                                                                                                                 |   | N                                                                              | I    |
| `include` include another file                                                                                                                        | Y |                                                                                |      |
| `payee` pre-declare payee names                                                                                                                       | Y |                                                                                |      |
| `payee` subdirectives                                                                                                                                 |   | N                                                                              | I/S  |
| `apply tag` assign a tag to transactions                                                                                                              |   | N                                                                              | I    |
| `tag` pre-declare tag names                                                                                                                           |   | ignored                                                                        | S    |
| `test`, a synonym for `comment`                                                                                                                       |   | N                                                                              | E    |
| `year`/`Y` set the year for year-less dates                                                                                                           |   | only `Y`                                                                       | S    |
| `N COMM` ignore pricing information for a commodity                                                                                                   |   | ignored                                                                        | I    |
| `D AMT` set a default commodity and its format                                                                                                        | Y |                                                                                |      |
| `C AMT1 = AMT2` declare a commodity equivalency                                                                                                       |   | N                                                                              | I/S  |
| `I, i, O, o, b, h` timeclock entries                                                                                                                  |   | timeclock data must be in a separate file (can be `include`d)                  | E    |
