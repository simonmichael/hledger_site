...
| [5.15 Virtual posting costs](https://www.ledger-cli.org/3.0/doc/ledger3.html#Virtual-posting-costs)                                                   | I        | I   | the parentheses have no effect                                                 | I    |
| [5.16 Commodity prices](https://www.ledger-cli.org/3.0/doc/ledger3.html#Commodity-prices)                                                             | N        | N   | cost basis is not tracked separately from cost                                 | Y    |
| [5.16.1 Total commodity prices](https://www.ledger-cli.org/3.0/doc/ledger3.html#Total-commodity-prices)                                               | N        | N   | some lot notation is ignored, but transactions may fail to balance             | Y    |
| [5.17 Prices versus costs](https://www.ledger-cli.org/3.0/doc/ledger3.html#Prices-versus-costs)                                                       | N        | N   |                                                                                |      |
| [5.18 Fixated prices and costs](https://www.ledger-cli.org/3.0/doc/ledger3.html#Fixated-prices-and-costs)                                             | N        | N   |                                                                                |      |
| [5.19 Lot dates](https://www.ledger-cli.org/3.0/doc/ledger3.html#Lot-dates)                                                                           | N        | N   |                                                                                | Y    |
| [5.20 Lot notes](https://www.ledger-cli.org/3.0/doc/ledger3.html#Lot-notes)                                                                           | N        | N   |                                                                                | Y    |
...
| `~` A periodic transaction.                                                                                                                           | Y        | Y   | some period expressions not supported                                          | Y    |
| `;` `#` `%` `*` &#124; comment lines                                                                                                                  | Y        | Y   | but not `%` or &#124;                                                          |      |
| `!` or `@` as a directive prefix                                                                                                                      | not `@`  | Y   |                                                                                | Y    |
| `account` pre-declare account names                                                                                                                   | Y        | Y   |                                                                                |      |
| `account` subdirectives                                                                                                                               | I        | I   |                                                                                | I/Y  |
| `apply account` set a default parent account                                                                                                          | Y        | Y   |                                                                                |      |
| `apply fixed` set fixated prices                                                                                                                      | N        | I   |                                                                                | I    |
| `apply tag` assign a tag to transactions                                                                                                              | N        | I   |                                                                                | I    |
| `alias` rewrite account names                                                                                                                         | Y        | Y   |                                                                                |      |
| `assert` error if a value expression fails                                                                                                            | N        | I   | use hledger check or hledger-check-fancyassertions                             | I    |
| `bucket`/`A` set a default balancing account                                                                                                          | N        | I   |                                                                                | I    |
| `capture` replace accounts matched by regex with another                                                                                              | N        | I   | can be emulated with regex `alias`                                             | I    |
| `check` warn if a value expression fails                                                                                                              | N        | I   | use hledger check or hledger-check-fancyassertions                             | I    |
...
| `define` define value expressions for future use                                                                                                      | N        | I   |                                                                                | I    |
| `end`/`end apply` shorthand for ending most recent apply block                                                                                        | N        | N   |                                                                                | N    |
| `end apply account`                                                                                                                                   | Y        | Y   |                                                                                | Y    |
| `end apply fixed`                                                                                                                                     | N        | I   |                                                                                | I    |
| `end apply tag`                                                                                                                                       | N        | I   |                                                                                | I    |
| `end apply year`                                                                                                                                      | N        | I   |                                                                                | I    |
| `end tag`                                                                                                                                             | N        | I   |                                                                                | I    |
| `eval` evaluate some (python?) expression                                                                                                             | N        | I   |                                                                                | I    |
| `expr` evaluate some value expression                                                                                                                 | N        | I   |                                                                                | I    |
| `include` include another file                                                                                                                        | Y        | Y   |                                                                                |      |
| `payee` pre-declare payee names                                                                                                                       | Y        | Y   |                                                                                |      |
| `payee` subdirectives                                                                                                                                 | N        | I   |                                                                                | I/Y  |
| `python` embed python in journal                                                                                                                      | N        | I   |                                                                                | I    |
| `tag` pre-declare tag names                                                                                                                           | I        | I   |                                                                                | Y    |
| `tag` subdirectives                                                                                                                                   | N        | I   |                                                                                | I    |
| `test`, a synonym for `comment`                                                                                                                       | N        | N   |                                                                                |      |
| `value EXPR` set a default valuation function for all commodities                                                                                     | N        | I   |                                                                                | I    |
| `Y`/`year`/`apply year` set the year for year-less dates                                                                                              | only `Y` | Y   |                                                                                | Y    |
| `N COMM` ignore pricing information for a commodity                                                                                                   | I        | I   |                                                                                | I    |
...
| `--flag` command-line flags in journal                                                                                                                | N        | I   |                                                                                | I    |
