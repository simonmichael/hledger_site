...
1. Make a local copy of the [bin/simplefinsetup,simplefinjson,simplefincsv](https://github.com/plaintextaccounting/hledger/tree/main/bin#simplefinsetup) scripts.
...
5. In a [rules file](hledger.md#csv) for each bank account, configure a [source rule](hledger.md#source) to read that account's data:
    ```rules
