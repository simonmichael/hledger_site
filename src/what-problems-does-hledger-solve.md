...
**I don't have an effective accounting system, and are experiencing financial chaos, loss, or worry**\
...
hledger is one very dependable accounting tool that scales smoothly from very basic to very advanced needs.
...
**My accounting software is opaque, and you worry about messing up your data**\
...
**I like the idea of Plain Text Accounting, but are finding it hard to get started.**\
...
**My accounting software is not improving, and you would prefer a tool that's actively maintained and supported.**\
