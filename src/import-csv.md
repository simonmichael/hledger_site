...
There is also a [Makefile](https://github.com/hledgerorg/hledger/blob/main/examples/csv/Makefile)
...
[examples/csv/]: https://github.com/hledgerorg/hledger/tree/main/examples/csv
