...
1. [Check your hledger installation](#check-your-hledger-installation)
1. [Locate your journal file with "hledger stats"](#locate-your-journal-file-with-hledger-stats)
1. [Record a transaction with "hledger add"](#record-a-transaction-with-hledger-add)
1. [Show transactions with "hledger print"](#show-transactions-with-hledger-print)
1. [Examine your journal file](#examine-your-journal-file)
1. [A convenience: inferred amounts](#a-convenience-inferred-amounts)
1. [Edit the journal file](#edit-the-journal-file)
1. [Two spaces](#two-spaces)
1. [Unbalanced transactions](#unbalanced-transactions)
1. [Record a transaction by editing](#record-a-transaction-by-editing)
1. [Show postings and a running total with "hledger register"](#show-postings-and-a-running-total-with-hledger-register)
1. [Show a per-account register report](#show-a-per-account-register-report)
1. [Set initial account balances](#set-initial-account-balances)
