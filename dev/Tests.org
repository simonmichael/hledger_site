...
Our unit tests use [[http://hackage.haskell.org/package/easytest][easytest]] and some [[https://github.com/simonmichael/hledger/blob/master/hledger-lib/Hledger/Utils/Test.hs][helpers]] provided by Hledger.Utils.Test,
...
- and scalable (usable for all devs, suitable for small/large modules/packages, easy to run).
