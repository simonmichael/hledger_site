...
module Foo (
  ...
  easytests_Foo -- export this module's and submodules' tests
)
where
import Hledger  -- provides Hledger.Utils.Test helpers
import Bar      -- submodules, providing easytests_Bar etc.
import Baz
...
easytests_Foo = tests "Foo" [ -- define tests at the end of each module
  ...
  ,easytests_Foo            -- aggregate submodule tests
  ,easytests_Bar
  ]
#+END_SRC
